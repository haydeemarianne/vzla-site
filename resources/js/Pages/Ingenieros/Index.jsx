...
function GroupDivider({ label, total }) {
    return (
        <div style={{ width: 1, flexShrink: 0, background: '#e9ebf1', alignSelf: 'stretch', position: 'relative', margin: '0 4px' }}>
            <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: '#f8fafc', border: '1px solid #e9ebf1', borderRadius: 8, padding: '6px 10px', writingMode: 'vertical-rl', fontSize: 10, fontWeight: 700, letterSpacing: '.5px', textTransform: 'uppercase', color: '#94a3b8', whiteSpace: 'nowrap' }}>
                {label} · {total}
            </div>
        </div>
    );
