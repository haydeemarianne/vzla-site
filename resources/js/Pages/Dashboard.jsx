...
import { Heart, Sparkles, Wrench, Truck, Package, ArrowRight, Plus, MapPin, Users } from 'lucide-react';
// Plus sigue en ACCIONES (botón Publicar caso en la grilla)
                ...
                {cases.length > 0 && (
                    <div style={CARD_STYLE}>
                        ...
                        <div style={{
                            ...
                            <span style={{ fontSize:16, fontWeight:700, color:'#2b3340' }}>
                                Casos urgentes
                            </span>
                            <Link href="/casos" style={{
                                display:'flex', alignItems:'center', gap:4,
                                fontSize:12.5, fontWeight:600, color:'#4263ac', textDecoration:'none',
                            }}>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{ flex:1, minWidth:0 }}>
                                        <div style={{
                                            fontSize:13.5, fontWeight:600, color:'#2b3340',
                                            overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap',
                                        }}>
                                            {name}
                                        </div>
                                        <div style={{ display:'flex', alignItems:'center', gap:3, marginTop:2 }}>
                                            <MapPin size={10} color="#7b8595" strokeWidth={2}/>
                                            <span style={{
                                                fontSize:11.5, color:'#7b8595',
                                                overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap',
                                            }}>
                                    ...
                                    <div style={{ display:'flex', flexDirection:'column', gap:3, flexShrink:0 }}>
                                        {needs.map(n => (
                                            <span key={n} style={{
                                                background:'#f3f4f8', color:'#5b6677',
                    ...
                    <div style={CARD_STYLE}>
                        <div style={{
                            ...
                            <Link href="/limpieza" style={{
                                display:'flex', alignItems:'center', gap:4,
                                fontSize:12.5, fontWeight:600, color:'#16a34a', textDecoration:'none',
                            }}>
                            ...
                            >
                                ...
                                <div style={{ flex:1, minWidth:0 }}>
                                    ...
                                    <div style={{
                                        ...
                                        <Users size={10} color="#7b8595" strokeWidth={2}/>
